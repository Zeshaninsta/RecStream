      ...
      <div className="w-full lg:w-[50%] m-auto p-5 flex flex-col justify-center items-center gap-10">
        <div className="w-full lg:w-[70%] border border-slate-700 rounded-xl p-5 flex flex-col justify-center items-center">
          <div className="relative flex flex-col justify-center items-center">
            <h1 className="text-4xl font-rubik text-gray-900 font-bold ">
              Signup
            </h1>
            <h1 className="absolute -top-5 -left-5 text-7xl font-rubik text-gray-900/10 font-bold ">
              Sign
            </h1>
          </div>
          ...
          {!secondpage ? (
            <div className="w-full flex flex-col justify-center items-center">
              <label
                htmlFor="Name"
                className="w-full lg:w-[70%] text-gray-900 flex flex-col gap-2 m-2"
              >
                Name
                <input
                  type="text"
                  className="w-full text-gray-900 bg-transparent p-5 border border-slate-800 outline-none focus:border-blue-500"
                  placeholder="Name: "
                  value={Name}
              ...
              <label
                htmlFor="Password"
                className="text-gray-900 w-full lg:w-[70%] flex flex-col gap-2 m-2"
              >
                Password
                <input
                  type="password"
          ...
          {!secondpage ? (
            <button
              className="w-[150px] p-2 bg-blue-500 hover:bg-blue-600 duration-200 rounded-sm text-gray-900 font-rubik font-bold m-5"
              onClick={Next}
            >
              Next
            </button>
            ...
            <div className="flex justify-evenly items-center gap-2">
              ...
              <button
                className="w-[150px] p-2 bg-red-500 hover:bg-red-600 duration-200 rounded-sm text-gray-900 font-rubik font-bold m-5"
                onClick={Next}
              >
                Back
              </button>
          ...
          <p className="text-gray-900 font-rubik leading-normal text-sm">
