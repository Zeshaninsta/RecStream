...
const Userprofile = () => {
  ...
  return (
      <div className="flex w-full lg:w-[90%] m-auto justify-start items-start min-h-screen relative">
        <button
          className="z-50 lg:hidden p-2 text-xl absolute top-2 left-5 text-gray-900 rounded-full  duration-500 cursor-pointer"
          onClick={toggleSidebar}
        >
          <AiOutlineMenu />
        </button>
        <div
          className={`absolute lg:static z-30 top-0 left-0 w-4/5 lg:w-1/5 h-full p-5 transition-transform transform ${
        ...
        >
          {userData && (
            <div className="md:h-screen overflow-hidden">
              ...
              <div className="mt-5 flex flex-col gap-5 text-gray-900">
                <button
