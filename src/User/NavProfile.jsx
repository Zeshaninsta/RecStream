  ...
  return (
    <div className="relative w-full">
      ...
      >
        ...
        {show && (
          <div className="z-50 p-5 flex flex-col justify-between items-center w-[300px] lg:w-[200px] h-[400px] bg-transparent backdrop-blur-xl border border-slate-800 absolute top-20 lg:-right-10 right-0 ">
            <div className="w-full flex flex-col bg-transparent backdrop:blur-md">
              <div className="w-full mb-5 text-center ">
                <h1 className="text-gray-900 font-rubik text-sm">
