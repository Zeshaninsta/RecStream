      ...
      <div className="w-full flex flex-col justify-center items-center ">
        {userData && (
          ...
          >
            ...
            <div className="mt-5 flex items-center text-gray-900 w-full">
              {!editingBios ? (
                <div className="flex flex-col justify-center items-center w-full">
                  <div className="flex justify-center items-center bg-transparent gap-1 backdrop-blur-md border border-slate-700 lg w-full rounded-full ">
                    <p className="text-md  text-gray-700 font-rubik ">
                    ...
                    >
                      <AiOutlineEdit className="p-2 w-10 h-10 rounded-full text-gray-900" />
                    </button>
                  </div>
                </div>
              ) : (
                <div className="flex justify-around items-center  m-auto gap-2">
                  ...
                  <button
                    ...
                    className="bg-blue-500 text-gray-900 px-4 py-2 mt-2 rounded hover:bg-blue-600"
                  >
                    Save
                  </button>
                </div>
